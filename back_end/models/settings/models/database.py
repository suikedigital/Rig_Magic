...
class SettingsDatabase:
    ...
    def save_settings(self, settings):
        self.conn.execute(
            "INSERT OR REPLACE INTO settings (yacht_id, base_id, wind_speed_in_knots, length_safety_factor, halyard_load_safety_factor, dynamic_load_safety_factor) VALUES (?, ?, ?, ?, ?, ?)",
            (
                settings.yacht_id,
                settings.base_id,
