...
def get_ropes(yacht_id: int):
    ...
    keys = ["id", "yacht_id", "base_id", "rope_type", "construction", "colour", "length", "diameter", "upper_term_type", "upper_hardware", "lower_term_type", "lower_hardware", "led_aft", "required_wl_kg", "config"]
