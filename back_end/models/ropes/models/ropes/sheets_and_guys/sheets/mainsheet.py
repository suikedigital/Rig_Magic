...
from back_end.models.ropes.models.ropes.sheets_and_guys.sheets.base_sheet import Sheet
...
class MainSheet(Sheet):
    ...
    def calc_length(self, yacht) -> float:
        ...
        return self.round_up_half_meter(2.0 * yacht.saildata.main_e + 1.5 * yacht.boat_length)
