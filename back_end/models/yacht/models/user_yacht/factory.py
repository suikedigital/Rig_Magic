...
from models.yacht.models.user_yacht.user_yacht import UserYacht
...
class UserYachtFactory:
    ...
    def create_user_yacht_from_base(base_yacht_id, owner_id, name, services):
        ...
        yacht_id = UserYachtService().save_user_yacht(user_yacht)
    ...
    def get_user_yacht(yacht_id, user_id=None):
        ...
        """
        user_yacht_service = UserYachtService()
