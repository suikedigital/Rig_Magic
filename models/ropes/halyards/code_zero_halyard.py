...
class CodeZeroHalyard(Halyard):
    ...
    def __init__(self, yacht, led_aft: float,
        ...
        """
        Initialize a Code Zero Halyard.
    ...
    def calc_length(self) -> float:
        ...
        """
        raw_length = (
            self.yacht.saildata.codezero_i
            + sqrt(self.yacht.saildata.codezero_i ** 2 + self.yacht.saildata.codezero_j ** 2)
            + self.led_aft
            + self.safety_margin
        )
