...
class GenoaSheet(Sheet):
    ...
    default_colour = "Solid Navy Blue"
    ...
    def __init__(self, yacht, 
        ...
        self.type = "Genoa Sheet"
    
    def calc_length(self) -> float:
        """
        Calculate the length of the genoa sheet.

        Returns:
            float: The calculated and rounded-up length in meters.
        """
        raw_length = (self.yacht.boat_length * 1.5) + self.safety_margin
