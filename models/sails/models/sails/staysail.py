...
class Staysail(BaseSail):
    ...
    def __init__(self, saildata, luff=None, leech=None, foot=None, yacht_id=None):
        default_luff = sqrt(saildata["staysail_i"] ** 2 + saildata["staysail_j"] ** 2)
        luff = luff if luff is not None else default_luff
        foot = foot if foot is not None else saildata["staysail_j"]
    ...
    def area(self) -> float:
        """
        Calculate the area of the staysail foresail in square meters.
        Returns:
