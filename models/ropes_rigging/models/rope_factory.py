...
class Factory:
    ...
    def _to_classname(self, rope_type):
        """
        Convert RopeType enum or string to class name string.
        """
    ...
    def generate_all_ropes_on_boat(self, rope_registry=None):
        ...
        for rope_type in self.rope_types:
            ...
            rope_class = rope_registry.get(rope_type)
            if rope_class is None:
                raise KeyError(f"Rope class for '{rope_type}' not found in registry.")
            rope = rope_class(
